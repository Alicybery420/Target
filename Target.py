...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              Fuck you Mark sister")
    runntxt(WW+"   ..................  Ali Cybery Fuck Mark sister")
    runntxt(WW+"     ....       Ali_Cybery")
    runntxt(GL+"                   Ali👉    Rule the world")
    runntxt(GG+"     ..........     You only live once")
    runntxt(Y+"    ............       Fuck the System")
    runntxt(GG+"           Fuck Love🖕")
    time.sleep(1.5)
    print GG+"  âˆš=============================================âˆš"
    print GL+"  |â€¢â€¢â€¢â€¢â€¢â€¢   NEW TOOLS HACK FACEBOOK BF.   â€¢â€¢â€¢â€¢â€¢â€¢|"
    print GG+"  âˆš=============================================âˆš"
    print WW+"  |            MOD BY: Ali_Cybery             |"
    print GL+"  |       Never  Trust anyone      |"
    print WW+"  |        TEAM : Ali Cybery Hacking team          |"
    print Y+"  |             INSTAGRAM: Fuck Insta🖕             |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ L.O.P ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  âˆš=============================================âˆš"
    print GL+"  |â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢   HACK FACEBOOK MAS ^_^   â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢|"
    print GG+"  âˆš=============================================âˆš"

banner()

print wd+"         gunakan dengan bijak cok "
print GG+"â•­â”€â”€â”€â”€\033[91m[\033[96m Masukkan ID\033[95m / \033[96mUsername Target\033[91m ] "
email_target = str(raw_input(GL+"\033[92mâ•°â”€â”€â”€â”€âž²\033[93m  "))
print " "
print "\033[92mâ•­â”€â”€â”€â”€\033[91m[ \033[96mMasukkan File Wordlist \033[95m( pass.txt ) \033[91;1m]"
password_list = str(raw_input(GG+"â•°â”€â”€â”€â”€âž²\033[93m "))
